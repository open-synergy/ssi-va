    ...
    tour.register(
        ...
        [].concat(
            ...
            [
                ...
                // This is an inaccuracy in docs/va_biller/05-activate.md;
                // changing IK files is explicitly out of scope for this
                // change, so it is reported on the IK issue instead of being
                // patched here.
