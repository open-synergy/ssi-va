...
3. Click the **Add Generate VA Wizard** button (`action_create_va_wizard`) in the header.
...
4. Optional: click **Add Generate VA Wizard** again on the same record. Pressing it
   ...
   being rejected as a duplicate. The first press names the binding **Generate VA**; each
   following press is numbered (**Generate VA #2**, **Generate VA #3**, …).
